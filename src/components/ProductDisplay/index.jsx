    ...
    return (
      ...
      <Section title="Refeição"/>
        <div className="carousel-product" ref={carouselRef}>
            <div className="FiChevronRight">
               <button onClick={handleLeftClick}> <FiChevronLeft /></button>
        ...
        
      {
            ...
            const { id, name, description, prices, image, category} = product;
                if(category === "refeição") {
                ...
                return (
                        ...
                        <div className="preview-product" key={id}>
                            ...
                            <img src={image} />
                            <span className="name-product">{name} <FaChevronRight/> </span>
                            <span className="description-product">{description}</span>
                            <span className="price-product">R$ {prices} </span>
